...
int main(int argc, char *argv[])
{
    try
    {
        ...
        if (argc == 7)
        {
            ...
            params.setParameter("COST_FUNC", COST_FUNC);

            std::cout << "Network: " << g_NETWORK << std::endl
                      << "OD: " << g_OD_MATRIX << std::endl
                      << "Cost function: " << COST_FUNC << std::endl;
        }
