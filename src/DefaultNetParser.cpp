...
//DefaultNetParser::DefaultNetParser(const std::string &fileWithNetwork) : fileWithNetwork_(fileWithNetwork){};

DefaultNetParser::DefaultNetParser(const std::string &fileWithNetwork,
                                   std::string costfunc) : fileWithNetwork_(fileWithNetwork), costfunc_(costfunc){};
